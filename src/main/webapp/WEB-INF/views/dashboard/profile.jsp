...
<div class="container">
    ...
    <div class="row border rounded-3 p-3 mb-4">
        ...
        <div class="col-2 " style="margin-top:60px; margin-right:3px; margin-left:23px">
            <a href="update-profile" class="btn btn-secondary">Edit Profile</a>
        </div>
        <div class="col-3" style="margin-left:600px; margin-top:-170px">
            <div>
...
<div class="row" style="margin-left:105px; margin-bottom:60px">
        <div class="col-9">
            <div class="mb-3">
                <h3>About Me</h3>
                <hr>
